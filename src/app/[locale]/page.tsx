        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-600">{isRTL ? 'شركة' : 'Companies'}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-blue-600">50K+</div>
              <div className="text-gray-600">{isRTL ? 'طلب' : 'Requests'}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-blue-600">98%</div>
              <div className="text-gray-600">{isRTL ? 'رضا العملاء' : 'Satisfaction'}</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href={`/${locale}/directory`}>{isRTL ? 'الشركات' : 'Companies'}</Link></li>
                <li><Link href={`/${locale}/projects`}>{isRTL ? 'المشاريع' : 'Projects'}</Link></li>
                <li><Link href={`/${locale}/about`}>{isRTL ? 'عن المنصة' : 'About'}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href={`/${locale}/register`}>{isRTL ? 'التسجيل' : 'Register'}</Link></li>
                <li><Link href={`/${locale}/pricing`}>{isRTL ? 'الأسعار' : 'Pricing'}</Link></li>
              </ul>
            </div>
