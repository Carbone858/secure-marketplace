...
const draftArticles: DraftArticle[] = [
  ...
  // Article 9: Contracting in Aleppo (EXPANDED DRAFT)
  {
    ...
    contentAr: `
      <figure className="my-6 overflow-hidden rounded-2xl border shadow-sm">
        <img 
          src="https://images.unsplash.com/photo-1541888946425-d0fbb186a5b3?q=80&w=1200&auto=format&fit=crop&fm=webp" 
      ...
      <ul>
        ...
        <li><strong>الإكساء الأساسي (الأسود):</strong> تمديد شبكات الكهرباء والسباكة واللياسة الإسمنتي والعزل المائي للأسطح والوجائب.</li>
